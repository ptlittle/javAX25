...
//
//		PacketHandlerStdout packetHandlerImpl = new PacketHandlerStdout();
...
//		}
//
//		String input = "default [default]"; // microphone
//		String output = "default [default]"; // speakers
//
//		int buffer_size = -1;
//		try {
...
//		try {
//			recordLinuxSpeakers.startRecording("weather_test.ax25");
//		} catch(Exception e) {
//			log.error(e.toString(), e);
//		}
//		
