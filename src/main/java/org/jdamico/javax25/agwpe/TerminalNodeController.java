...
@Slf4j
public class TerminalNodeController extends Thread implements PacketHandler {
	...
	public void handlePacket(byte[] bytes) {
		...
		try {
			...
			// We just ignore the error; the socket may have been closed and hopefully will
			// reopen later
		}
	}
	...
	public TerminalNodeController(Properties p) {
		/*** create Modem object ***/
	...
	public static void main(String[] args) {
		...
		TerminalNodeController tnc = new TerminalNodeController(p);
