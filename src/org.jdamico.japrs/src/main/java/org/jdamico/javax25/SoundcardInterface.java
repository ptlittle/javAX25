...
import org.jdamico.japrs.ax25.Afsk1200Modulator;
import org.jdamico.japrs.ax25.PacketDemodulator;
import org.jdamico.japrs.ax25.PacketHandler;
import org.jdamico.japrs.radiocontrol.SerialTransmitController;
import org.jdamico.japrs.radiocontrol.TransmitController;
import org.jdamico.japrs.soundcard.Soundcard;
import org.jdamico.japrs.threads.SoundcardWriteThread;
import org.jdamico.japrs.threads.TNCConnectThread;
	...
	public synchronized void init(Properties configuration)
	{
		...
		if (firstTime)
		{
	  	...
	  	System.err.println("Starting up Afsk1200 modem on ["+soundin+", "+soundout+"] at "+rate+" samples/s");
			...
			try {
	  	  modulator   = new org.jdamico.japrs.ax25.Afsk1200Modulator(rate);
	  	  demodulator = new org.jdamico.japrs.ax25.Afsk1200MultiDemodulator(rate,this);
	  	...
	  	sc   = new org.jdamico.japrs.soundcard.Soundcard(rate, soundin, soundout, latency_ms, 
