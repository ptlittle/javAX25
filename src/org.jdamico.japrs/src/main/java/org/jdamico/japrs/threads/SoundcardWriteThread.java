package org.jdamico.japrs.threads;
...
public final class SoundcardWriteThread extends TNCWriteThread {
	...
	private org.jdamico.japrs.soundcard.Soundcard sc;

	private org.jdamico.japrs.ax25.PacketDemodulator demodulator;
	private org.jdamico.japrs.ax25.PacketModulator modulator;
	...
	public void run() {
		...
		for (;;) {
			...
			try {
				...
				modulator.prepareToTransmit(new org.jdamico.japrs.ax25.Packet(newpacket));
				// key PTT
